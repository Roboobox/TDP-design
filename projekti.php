...
$title = $lang['myRoad'] . " - " . $lang['roadFourTitle'];
...
<header>
    ...
    <div class="container">
        <div class="hero-text fs-1 row justify-content-center">
            <h1><?=$lang['roadFourTitle']?></h1>
            <h2 class="hero-subtext text-center fs-5"><?=$lang['roadFourSubtitle']?></h2>
        </div>
    </div>
</header>
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="text-center next-stage mt-3 mb-5 position-relative">
                <a href="kursi.php" class="text-decoration-none">
                ...
                <?=$lang['roadGoBack']?><br>
                <span class="fw-bold"><?=$lang['roadThreeTitle']?></span>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-10 pb-3">
            <div class="row gx-4 row-cols-1 row-cols-md-2">
                <div class="col mb-4 mb-md-0">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road4Title1']?></h5>
                        <p class="text-start">
                            <?=$lang['road4Content1']?>
                        </p>
                    </div>
                ...
                <div class="col mb-4 mb-md-0">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road4Title2']?></h5>
                        <p class="text-start">
                            <?=$lang['road4Content2']?>
                        </p>
                    </div>
            ...
            <div class="row gx-4 mt-4 row-cols-1">
                <div class="col mb-4">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road4Title3']?></h5>
                        <p class="text-start">
                            <?=$lang['road4Content3']?>
                        </p>
                    </div>
                ...
                <div class="col mb-4">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road4Title4']?></h5>
                        <p class="text-start">
                            <?=$lang['road4Content4']?>
                        </p>
                    </div>
            ...
            <div class="text-center next-stage mt-3">
                <?=$lang['roadGoNext']?><br>
                <span class="fw-bold"><?=$lang['roadFiveTitle']?></span><br>
