...
$title = $lang['myRoad'] . " - " . $lang['roadSixTitle'];
...
<header>
    ...
    <div class="container">
        <div class="hero-text fs-1 row justify-content-center">
            <h1><?=$lang['roadSixTitle']?></h1>
            <h2 class="hero-subtext text-center fs-5"><?=$lang['roadSixSubtitle']?></h2>
        </div>
    </div>
</header>
    ...
    <div class="row">
        ...
        <div class="col-10">
            <div class="text-center next-stage mt-3 mb-5 position-relative">
                <a href="vidusskola.php" class="text-decoration-none">
                ...
                <?=$lang['roadGoBack']?><br>
                <span class="fw-bold"><?=$lang['roadFiveTitle']?></span>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-10 pb-3">
            <div class="row gx-4 row-cols-1 row-cols-md-2">
                <div class="col mb-4 mb-md-0">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road6Title1']?></h5>
                        <p class="text-start">
                            <?=$lang['road6Content1']?>
                        </p>
                    </div>
                ...
                <div class="col mb-4 mb-md-0">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road6Title2']?></h5>
                        <p class="text-start">
                            <?=$lang['road6Content2']?>
                        </p>
                    </div>
            ...
            <div class="row gx-4 mt-4 row-cols-1">
                <div class="col mb-4">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road6Title3']?></h5>
                        <p class="text-start">
                            <?=$lang['road6Content3']?>
                        </p>
                    </div>
                ...
                <div class="col mb-4">
                    <div class="p-4 border rounded shadow-sm h-100">
                        ...
                        <h5 class="text-center my-2 fw-bold"><?=$lang['road6Title4']?></h5>
                        <p class="text-start">
                            <?=$lang['road6Content4']?>
                        </p>
                    </div>
            ...
            <div class="text-center next-stage mt-3">
                <?=$lang['roadGoNext']?><br>
                <span class="fw-bold"><?=$lang['roadSevenTitle']?></span><br>
